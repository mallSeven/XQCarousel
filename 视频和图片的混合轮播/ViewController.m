...
- (void)viewDidLoad {
     ...
     **/
    XQCarousel *carousel = [XQCarousel scrollViewFrame:CGRectMake(0, 64, self.view.frame.size.width, 300) imageStringGroup:@[@"http://yun.it7090.com/video/XHLaunchAd/video03.mp4", @"1.jpg", @"2.jpg", @"3.jpg"]];
